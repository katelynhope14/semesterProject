    ...
    <div id="body">
      <h2>
        <router-link to="/user" replace
          >View or Change Personal Details</router-link
        >
      </h2>
      <!--Tableware and Serving Table-->
      <section>
        <h3>Tableware and Serving</h3>
        <div id="tableware">
          <table>
            <tr>
              <th>Item</th>
            ...
            <tr>
              ...
              <br /><select v-model="tablecoversButton">
                <option
                  >{{ priceInfo[31].desc1 }} -
                  {{ priceInfo[31].price1 }}</option
                >
                <option
                  >{{ priceInfo[31].desc2 }} -
                  {{ priceInfo[31].price2 }}</option
                >
                <option
                  >{{ priceInfo[31].desc3 }} -
                  {{ priceInfo[31].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!tablecoversButton"
                class="button"
                @click="addCart(tableCovers.object, tablecoversButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="plateButton">
                <option
                  >{{ priceInfo[25].desc1 }} -
                  {{ priceInfo[25].price1 }}</option
                >
                <option
                  >{{ priceInfo[25].desc2 }} -
                  {{ priceInfo[25].price2 }}</option
                >
                <option
                  >{{ priceInfo[25].desc3 }} -
                  {{ priceInfo[25].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!plateButton"
                class="button"
                @click="addCart(plasticPlate.object, plateButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="cutleryButton">
                <option
                  >{{ priceInfo[7].desc1 }} - {{ priceInfo[7].price1 }}</option
                >
                <option
                  >{{ priceInfo[7].desc2 }} - {{ priceInfo[7].price2 }}</option
                >
                <option
                  >{{ priceInfo[7].desc3 }} - {{ priceInfo[7].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!cutleryButton"
                class="button"
                @click="addCart(plasticCutlery.object, cutleryButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="napkinButton">
                <option
                  >{{ priceInfo[17].desc1 }} -
                  {{ priceInfo[17].price1 }}</option
                >
                <option
                  >{{ priceInfo[17].desc2 }} -
                  {{ priceInfo[17].price2 }}</option
                >
                <option
                  >{{ priceInfo[17].desc3 }} -
                  {{ priceInfo[17].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!napkinButton"
                class="button"
                @click="addCart(napkins.object, napkinButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="drinkwareButton">
                <option
                  >{{ priceInfo[9].desc1 }} - {{ priceInfo[9].price1 }}</option
                >
                <option
                  >{{ priceInfo[9].desc2 }} - {{ priceInfo[9].price2 }}</option
                >
                <option
                  >{{ priceInfo[9].desc3 }} - {{ priceInfo[9].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!drinkwareButton"
                class="button"
                @click="addCart(drinkware.object, drinkwareButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="servewareButton">
                <option
                  >{{ priceInfo[27].desc1 }} -
                  {{ priceInfo[27].price1 }}</option
                >
                <option
                  >{{ priceInfo[27].desc2 }} -
                  {{ priceInfo[27].price2 }}</option
                >
                <option
                  >{{ priceInfo[27].desc3 }} -
                  {{ priceInfo[27].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!servewareButton"
                class="button"
                @click="addCart(serveware.object, servewareButton)"
              >
                Add Cart
              </button>
            </tr>
          ...
          <table>
            ...
            <tr>
              ...
              <br /><select v-model="balloonButton">
                <option
                  >{{ priceInfo[3].desc1 }} - {{ priceInfo[3].price1 }}</option
                >
                <option
                  >{{ priceInfo[3].desc2 }} - {{ priceInfo[3].price2 }}</option
                >
                <option
                  >{{ priceInfo[3].desc3 }} - {{ priceInfo[3].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!balloonButton"
                class="button"
                @click="addCart(balloon.object, balloonButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="curtainsButton">
                <option
                  >{{ priceInfo[5].desc1 }} - {{ priceInfo[5].price1 }}</option
                >
                <option
                  >{{ priceInfo[5].desc2 }} - {{ priceInfo[5].price2 }}</option
                >
                <option
                  >{{ priceInfo[5].desc3 }} - {{ priceInfo[5].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!curtainsButton"
                class="button"
                @click="addCart(curtains.object, curtainsButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="yardButton">
                <option
                  >{{ priceInfo[33].desc1 }} -
                  {{ priceInfo[33].price1 }}</option
                >
                <option
                  >{{ priceInfo[33].desc2 }} -
                  {{ priceInfo[33].price2 }}</option
                >
                <option
                  >{{ priceInfo[33].desc3 }} -
                  {{ priceInfo[33].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!yardButton"
                class="button"
                @click="addCart(yard.object, yardButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="photoboothButton">
                <option
                  >{{ priceInfo[23].desc1 }} -
                  {{ priceInfo[23].price1 }}</option
                >
                <option
                  >{{ priceInfo[23].desc2 }} -
                  {{ priceInfo[23].price2 }}</option
                >
                <option
                  >{{ priceInfo[23].desc3 }} -
                  {{ priceInfo[23].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!photoboothButton"
                class="button"
                @click="addCart(photobooth.object, photoboothButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="lightsButton">
                <option
                  >{{ priceInfo[15].desc1 }} -
                  {{ priceInfo[15].price1 }}</option
                >
                <option
                  >{{ priceInfo[15].desc2 }} -
                  {{ priceInfo[15].price2 }}</option
                >
                <option
                  >{{ priceInfo[15].desc3 }} -
                  {{ priceInfo[15].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!lightsButton"
                class="button"
                @click="addCart(lights.object, lightsButton)"
              >
                Add Cart
              </button>
            </tr>
          ...
          <table>
            ...
            <tr>
              ...
              <br /><select v-model="noiseMakersButton">
                <option
                  >{{ priceInfo[19].desc1 }} -
                  {{ priceInfo[19].price1 }}</option
                >
                <option
                  >{{ priceInfo[19].desc2 }} -
                  {{ priceInfo[19].price2 }}</option
                >
                <option
                  >{{ priceInfo[19].desc3 }} -
                  {{ priceInfo[19].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!noiseMakersButton"
                class="button"
                @click="addCart(noiseMakers.object, noiseMakersButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="partyHatsButton">
                <option
                  >{{ priceInfo[21].desc1 }} -
                  {{ priceInfo[21].price1 }}</option
                >
                <option
                  >{{ priceInfo[21].desc2 }} -
                  {{ priceInfo[21].price2 }}</option
                >
                <option
                  >{{ priceInfo[21].desc3 }} -
                  {{ priceInfo[21].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!partyHatsButton"
                class="button"
                @click="addCart(partyHats.object, partyHatsButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="awardsButton">
                <option
                  >{{ priceInfo[1].desc1 }} - {{ priceInfo[1].price1 }}</option
                >
                <option
                  >{{ priceInfo[1].desc2 }} - {{ priceInfo[1].price2 }}</option
                >
                <option
                  >{{ priceInfo[1].desc3 }} - {{ priceInfo[1].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!awardsButton"
                class="button"
                @click="addCart(awards.object, awardsButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="glowSticksButton">
                <option
                  >{{ priceInfo[11].desc1 }} -
                  {{ priceInfo[11].price1 }}</option
                >
                <option
                  >{{ priceInfo[11].desc2 }} -
                  {{ priceInfo[11].price2 }}</option
                >
                <option
                  >{{ priceInfo[11].desc3 }} -
                  {{ priceInfo[11].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!glowSticksButton"
                class="button"
                @click="addCart(glowSticks.object, glowSticksButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="keychainsButton">
                <option
                  >{{ priceInfo[13].desc1 }} -
                  {{ priceInfo[13].price1 }}</option
                >
                <option
                  >{{ priceInfo[13].desc2 }} -
                  {{ priceInfo[13].price2 }}</option
                >
                <option
                  >{{ priceInfo[13].desc3 }} -
                  {{ priceInfo[13].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!keychainsButton"
                class="button"
                @click="addCart(keychains.object, keychainsButton)"
              >
                Add Cart
              </button>
            </tr>
            ...
            <tr>
              ...
              <br /><select v-model="stickersButton">
                <option
                  >{{ priceInfo[29].desc1 }} -
                  {{ priceInfo[29].price1 }}</option
                >
                <option
                  >{{ priceInfo[29].desc2 }} -
                  {{ priceInfo[29].price2 }}</option
                >
                <option
                  >{{ priceInfo[29].desc3 }} -
                  {{ priceInfo[29].price3 }}</option
                > </select
              ><br />
              <button
                :disabled="!stickersButton"
                class="button"
                @click="addCart(stickers.object, stickersButton)"
              >
                Add Cart
              </button>
            </tr>
...
export default class MainPage extends Vue {
  ...
  checkout(): void {
    ...
    this.cart.forEach((item) => {
      this.$appDB.collection(`users/${this.uid}/cart`).add({
        name: item.itemName,
        desc: item.itemDesc,
  ...
  mounted(): void {
    this.uid = this.$appAuth.currentUser?.uid ?? "none";
    this.$appDB.collection(`prices`).onSnapshot((qs: QuerySnapshot) => {
  ...
  readonly yard = {
    ...
    quantity: ["10ct ($15.99)", "15ct ($17.99)", "20ct ($20.99)"],
  };
  ...
  addCart(name, desc) {
    ...
    this.total =
      this.total + parseFloat(fields[1]) + parseFloat(fields[1]) * 0.06;
  }
}
</script>
<style scoped>
